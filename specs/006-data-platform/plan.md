...
**Spec**: `specs/006-data-platform/spec.md`  
**Story**: CRM-037  
...
| Docs | `specs/006-data-platform/*`, constitution, product Next | CRM-037 |
...
2. Identity: if `ConnectionStrings:Identity` present → `Microsoft.Data.SqlClient`; else existing Sqlite `Identity:DataPath`.
