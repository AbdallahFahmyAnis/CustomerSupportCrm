...
- Part of Identity feature map: `specs/001-identity/feature.md`
...
- [x] Automated test `[Trait("Story", "CRM-046")]` (token issue/consume/expiry + no user enumeration)
- [x] Mock: can reset `customer@crm.local` (or a dedicated seed) via local/dev token path without production email
- [x] Spec, plan, and code cite `CRM-046`; listed under `specs/identity`
