...
**Spec**: `specs/007-sla/018-sla-automation/spec.md`  
...
- Assign: Technicalâ†’Demo; Urgentâ†’Lead; Highâ†’Lead; catch-allâ†’Demo (specificity: category+priority > one dimension > default)
