...
- `specs/016-channel-providers` outbound Twilio adapters
...
|---|---|---|---|
| (Ops) Channels README | `src/services/channels/README.md` or `specs/024-inbound-webhooks` | admin | Webhook paths + env documented |
