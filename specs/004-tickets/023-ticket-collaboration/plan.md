...
**Spec**: `specs/004-tickets/023-ticket-collaboration/spec.md`  
**Story**: CRM-016  
...
- For each mentioned userId â‰  author: `POST` notification `{ userId, title, body, kind: "mention", href: "/agent/tickets/{id}" }`
