...
- `specs/005-channels/016-channel-providers` outbound Twilio adapters
...
|---|---|---|---|
| (Ops) Channels README | `src/services/channels/README.md` or `specs/005-channels/024-inbound-webhooks` | admin | Webhook paths + env documented |
